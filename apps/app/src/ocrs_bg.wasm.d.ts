...
export const ocrengine_detectText: (
  a: number,
  b: number,
) => [number, number, number, number]
export const ocrengine_getText: (
  a: number,
  b: number,
) => [number, number, number, number]
export const ocrengine_getTextLines: (
  a: number,
  b: number,
) => [number, number, number, number]
export const ocrengine_loadImage: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const ocrengine_recognizeText: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const ocrengineinit_setDetectionModel: (
  a: number,
  b: number,
  c: number,
) => [number, number]
export const ocrengineinit_setRecognitionModel: (
  a: number,
  b: number,
  c: number,
) => [number, number]
