...
export interface InitOutput {
  ...
  readonly ocrengine_detectText: (
    a: number,
    b: number,
  ) => [number, number, number, number]
  readonly ocrengine_getText: (
    a: number,
    b: number,
  ) => [number, number, number, number]
  readonly ocrengine_getTextLines: (
    a: number,
    b: number,
  ) => [number, number, number, number]
  readonly ocrengine_loadImage: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly ocrengine_recognizeText: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly ocrengineinit_setDetectionModel: (
    a: number,
    b: number,
    c: number,
  ) => [number, number]
  readonly ocrengineinit_setRecognitionModel: (
    a: number,
    b: number,
    c: number,
  ) => [number, number]
